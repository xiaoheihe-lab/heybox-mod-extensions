...
const MOD_PATH = 'CodeVein/Content/Paks/~mods'
const PRIORITY = 25
const OPTIONS = { gameId: GAME_ID, gameName: 'Code Vein', modType: MOD_TYPE, requirePatchSuffix: false }
...
export default function main(context: IExtensionContext): boolean {
  context.registerGame({
    ...
    details: { steamAppId: GAME_ID, nexusGameDomainName: 'codevein', customOpenModsPath: MOD_PATH },
  })
