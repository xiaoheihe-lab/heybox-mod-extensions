...
Steam App ID: 678960; minimum Mod API: 1.17.0.
...
Reference: https://github.com/Nexus-Mods/vortex-games/tree/master/game-codevein
The official index.ts/common.ts were inspected. The first-Pak-directory routing and FOMOD exclusion follow that source. Unlike the Vortex installer, unrelated non-Pak files are not copied.

## Tester and installer

- Priority 30: testRoot / installRoot, mod type 678960-root, target {gamePath}.
- Recognizes CodeVein/Content, CodeVein/Binaries or CodeVein/Config file
...
- Priority 25: testPak / installPak, mod type 678960-pak.
- Target: {gamePath}/CodeVein/Content/Paks/~mods.
...
been linked. pnpm test builds only the ignored local dist/CodeVein output.
