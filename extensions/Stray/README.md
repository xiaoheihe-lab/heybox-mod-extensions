...
Steam App ID: 1332010; minimum Mod API: 1.17.0.
...
Reference: https://www.nexusmods.com/site/mods/430
The published extension description was inspected; the downloadable extension source was not retrieved.

## Tester and installer

- Priority 30: testRoot / installRoot, mod type 1332010-root, target {gamePath}.
- Recognizes Hk_project/Content, Hk_project/Binaries or Hk_project/Config file
...
- Priority 25: testPak / installPak, mod type 1332010-pak.
- Target: {gamePath}/Hk_project/Content/Paks/~mods.
...
- Normalizes destination filenames to end in _P.pak, including matching companions. This is automatic (unlike the optional Vortex rename prompt); archive source filenames remain unchanged.
...
been linked. pnpm test builds only the ignored local dist/Stray output.
